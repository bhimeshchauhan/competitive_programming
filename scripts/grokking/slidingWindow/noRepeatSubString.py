...
Input: String="abccde"
Output: 3
Explanation: Longest substrings without any 
...
def non_repeat_substring(str1):
    ...
    for window_end in range(len(str1)):
        ...
        if right_char in char_index_map:
            ...
            # and if 'window_start' is already ahead of 
            # the last index of 'right_char', we'll keep 'window_start'
...
def main():
    assert str(non_repeat_substring("aabccbb")) == '3'
    assert str(non_repeat_substring("abbbb")) == '2'
    assert str(non_repeat_substring("abccde")) == '3'
