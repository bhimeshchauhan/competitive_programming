...
"""
Point:
In between u and v there's no point in taking the edge that takes longer time. 
Since the passingFee depends on only u and v and not the edge. So take the edge that takes minimum time.
