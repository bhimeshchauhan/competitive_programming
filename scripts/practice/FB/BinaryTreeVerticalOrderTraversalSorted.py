...
Travel the tree using pre-order & store the (x, y) position of each node
Group the nodes into their respective vertical groups.
Generate the answer using the grouping
