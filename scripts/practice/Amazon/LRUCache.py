...
Space complexity : O(capacity) since the space is used only for a 
hashmap and double linked list with at most capacity + 1 elements.
...
ordered dictionary : get/in/set/move_to_end/popitem (get/containsKey/put/remove) 
